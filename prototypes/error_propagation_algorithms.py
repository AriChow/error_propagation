...
plt.legend()
plt.autoscale()
plt.savefig(results_home + 'figures/error_propagation_random_pipeline_algorithms_' + type1 + '_' + data_name + '.jpg')
plt.close()
...
plt.xticks(x1, steps)
plt.savefig(results_home + 'figures/propagation_factor_random_pipeline_algorithms_' + type1 + '_'  + data_name + '.jpg')
plt.close()
