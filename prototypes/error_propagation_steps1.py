...
plt.legend()
plt.autoscale()
plt.savefig(results_home + 'figures/error_propagation_random_pipeline_steps_alternative_matsc_dataset2.eps')
plt.close()
...
plt.xticks(x1, steps)
plt.savefig(results_home + 'figures/propagation_factor_random_pipeline_steps_alternative_matsc_dataset2.eps')
plt.close()
