...
pickle.dump(incumbent, open(home + '/Documents/research/EP_project/results/intermediate/smac_learning_algorithm_' + dataset + '.pkl', 'wb'), -1)
# pickle.dump(smac, open(home + '/Documents/research/EP_project/results/intermediate/smac_object_learning_algorithm_' + dataset + '.pkl', 'wb'), -1)
