...
for data_name in datasets:
	...
	plt.legend()
	plt.autoscale()
	plt.savefig(results_home + 'figures/error_propagation_random_pipeline_steps_' + data_name + '_test.jpg')
	plt.close()
	...
	plt.xticks(x1, steps)
	plt.savefig(results_home + 'figures/propagation_factor_random_pipeline_steps_' + data_name + '_test.jpg')
	plt.close()

	x = steps
	_, axs = plt.subplots(nrows=1, ncols=1)
	x1 = [1, 2, 3]
	axs.errorbar(x1, E_propagation_mean, E_propagation_std, linestyle='None', marker='^', capsize=3, color='b',
				 label='validation')
	axs.plot(x1, E_propagation_mean, color='b')
	axs.errorbar(x1, E_propagation_mean_test, E_propagation_std_test, linestyle='None', marker='^', capsize=3,
				 color='k', label='testing')
	...
	plt.savefig(results_home + 'figures/error_propagation_steps_' + data_name + '_val_test.jpg')
	plt.close()
