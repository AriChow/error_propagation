...
python random_mcmc_naive1.py breast barn
python random_mcmc_naive1.py matsc_dataset1 barn
python random_mcmc_naive1.py matsc_dataset2 barn
python random_mcmc_naive1.py brain barn
