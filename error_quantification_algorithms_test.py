...
for data_name in datasets:
	...
	axs.errorbar(x1, random_alg_error_test, random_alg_std_error_test, linestyle='None', marker='^', capsize=3, color='b', label='testing')
	axs.plot(x1, random_alg_error_test, color='b')
	labels = []
	cnt = 1
